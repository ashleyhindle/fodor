...
class HomepageTest extends TestCase
{
    ...
    {
        if (getenv('TRAVIS') === true || getenv('DEPLOY_USER') == 'fodor') { // we need to skip this for now as we don't have a github key/secret, so we can't get the fodor.json file so this page fails
