...
<head>
    ...
    <meta property="og:title" content="Fodor.xyz @if(isset($description))- auto setup and provision {{ $repo or 'GitHub repositories' }} on a new DigitalOcean {{'droplet'}}@endif" />
    ...
    <meta name="twitter:title" content="Fodor.xyz @if(isset($description))- auto setup and provision {{ $repo or 'GitHub repositories' }} on a new DigitalOcean {{'droplet'}}@endif" />
