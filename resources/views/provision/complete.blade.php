            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="https://twitter.com/intent/tweet?text=I've just setup+{{ $provision['repo'] }}+on @DigitalOcean at https://fodor.xyz/provision/{{ $provision['repo'] }} with @fodorxyz - couldn't have been easier!" target="_blank" type="button" class="btn btn-info">Tweet</a>
                    </div>
                </div>
            </div>
        </div>
