 ...
 */
class DigitalOceanLeagueOAuthProvider extends AbstractProvider
{
    ...
    public function revoke($token=null)
    {
        ...
        $url = $this->getBaseRevokeUrl();

        $request = $this->getRequest($this->getAccessTokenMethod(), $url, [
     ...
     * @inheritdoc
     */
    public function getBaseRevokeUrl()
    {
        return $this->urlRevoke;
    }
